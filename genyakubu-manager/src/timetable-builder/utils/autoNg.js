...
export function computeAutoNgEntries(teacherName, externalSessions, periods) {
  const out = new Map();
...
export function computeAutoNgByTeacher(teachers, externalSessions, periods) {
...
export function isEffectivelyNg(teacher, autoNgEntries, dateLabel, periodLabel) {
