...
export function gradeColor(g) {
  if (g.includes("附中")) return { bg: "#e8d5b7", fg: "#6b4c2a" };
  if (g.includes("中1")) return { bg: "#d4e8d4", fg: "#2a5a2a" };
  if (g.includes("中2")) return { bg: "#cce0f0", fg: "#1a4a6a" };
  if (g.includes("中3")) return { bg: "#e0d4f0", fg: "#4a2a7a" };
  if (g.includes("高1")) return { bg: "#f0e0c8", fg: "#7a5a1a" };
  if (g.includes("高2")) return { bg: "#f0ccc8", fg: "#7a2a1a" };
  if (g.includes("高3")) return { bg: "#c8c8f0", fg: "#1a1a7a" };
  return { bg: "#e8e8e8", fg: "#444" };
}
